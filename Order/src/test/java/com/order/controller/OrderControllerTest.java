...
public class OrderControllerTest {
	...
	public void testOrderPlaced() throws JsonProcessingException, Exception {
		...
		MvcResult result = mockMvc
				.perform(MockMvcRequestBuilders.post("/placeOrder")
						.content(new ObjectMapper().writeValueAsString(order)).contentType(MediaType.APPLICATION_JSON))
	...
	public void testOrderUpdated() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put("/updateOrder/1/")
				.content(new ObjectMapper().writeValueAsString(custadd)).contentType(MediaType.APPLICATION_JSON))
	...
	public void testAllOrderFetched() throws Exception {
		...
		MvcResult mvcresult = mockMvc
				.perform(MockMvcRequestBuilders.get("/fetchAllOrder").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk()).andDo(print()).andReturn();
