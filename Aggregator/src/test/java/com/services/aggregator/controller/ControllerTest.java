...
public class ControllerTest {
	...
	void testViewProductsByName() throws Exception {
		...
		MvcResult mvcresult = mockMvc.perform(MockMvcRequestBuilders.get("/enduser/searchProductbyname/Trimmer"))
	...
	void testUpdateMyDetails() throws Exception {
		...
		MvcResult mvcResult = mockMvc
				.perform(MockMvcRequestBuilders.patch("/enduser/updatemydetails/1")
	...
	void testDeleteOrder() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.delete("/enduser/deleteorder/1")).andDo(print())
				.andReturn();
		int status = mvcResult.getResponse().getStatus();
		assertEquals(200, status);
